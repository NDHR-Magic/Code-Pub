...
// Stolen from https://codesandbox.io/s/github/Tumne/react-roulette-wheel/tree/master/?file=/src/index.js:180-242 
...
class Roulette extends React.Component {
    ...
    drawRouletteWheel() {
        ...
        if (canvas.getContext) {
            ...
            const insideRadius = baseSize - 70;
    ...
    render() {
        ...
        return (
            <div className="roulette">
                ...
                <div className="roulette-container">
                    <input type="button" value="spin" onClick={this.handleOnClick} className="customBtn" id="spin" />
                </div>
            </div>
        );
    }
