...
const { Item, User, drinkItem, foodItem, Events, FavoriteDrinks } = require("../models");
...
const favoriteDrinkData = require("./favoriteDrink-seeds.json");
...
const seedAll = async () => {
    try {
        ...
        await FavoriteDrinks.bulkCreate(favoriteDrinkData);
        console.log("Seeded favorite drinks\n");
